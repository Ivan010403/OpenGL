...
void Pipeline::InitScaleTransform(Matrix4f& m) const // метод пересчёта масштаба
{
...
void Pipeline::InitRotateTransform(Matrix4f& m) const // метод вращения фигуры
{
    Matrix4f rx, ry, rz;
...
void Pipeline::InitTranslationTransform(Matrix4f& m) const // метод движения фигуры
{
...
void Pipeline::InitPerspectiveProj(Matrix4f& m) const // проекция перспективы
{
...
const Matrix4f* Pipeline::GetTrans() // финальный подсчёт матрицы преобразования
{
